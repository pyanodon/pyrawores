...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/hydroclassifier-mk01/h1-mk03.png",
                --priority = "high",
                width = 96,
                height = 227,
                line_length = 21,
            ...
            {
                filename = "__pyraworesgraphics__/graphics/entity/hydroclassifier-mk01/h2-mk03.png",
                --priority = "high",
                width = 96,
                height = 227,
                line_length = 21,
