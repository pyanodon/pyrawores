...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/wet-scrubber/wet-scrubber-base-mk04.png",
                width = 192,
                height = 224,
                frame_count = 1,
            ...
            {
                filename = "__pyraworesgraphics__/graphics/entity/wet-scrubber/top-off-mk04.png",
                width = 192,
                height = 128,
                frame_count = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/wet-scrubber/anim-mk04.png",
                --priority = "extra-high",
                frame_count = 2,
                width = 192,
                height = 128,
