...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/electrolyzer-mk01/off-mk02.png",
                width = 189,
                height = 192,
                --line_length = 9,
                frame_count = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/electrolyzer-mk01/on-mk02.png",
                priority = "high",
                frame_count = 60,
                line_length = 10,
                width = 160,
