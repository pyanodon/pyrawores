...
ITEM {
    type = "item",
    name = "eaf-mk03",
    icon = "__pyraworesgraphics__/graphics/icons/eaf-mk03.png",
    icon_size = 32,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/eaf-mk01/off-mk03.png",
                --priority = "high",
                width = 160,
                height = 192,
                --line_length = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/eaf-mk01/on-mk03.png",
                priority = "high",
                frame_count = 50,
                line_length = 10,
                width = 128,
