    ...
    ENTITY {
        ...
        fluid_boxes = {
            ...
            },
            {
                ...
                volume = 1000,
                base_level = -1,
                pipe_connections = {{flow_direction = 'input', position = {3.3, 0.0}, direction = defines.direction.east}}
            },
            {
                production_type = 'input',
                pipe_picture = py.pipe_pictures('assembling-machine-2', nil, {0.0, -0.96}, nil, nil),
                ...
                volume = 1000,
                base_level = -1,
                pipe_connections = {{flow_direction = 'input', position = {3.3, 2.0}, direction = defines.direction.east}}
            },
            {
                ...
                pipe_covers = py.pipe_covers(false, true, true, true),
                volume = 100,
                pipe_connections = {{flow_direction = 'output', position = {-3.3, 0.0}, direction = defines.direction.west}}
            },
