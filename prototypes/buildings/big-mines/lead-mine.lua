RECIPE {
    ...
    results = {
        {type = "item", name = "lead-mine", amount = 1}
    }
}:add_unlock("big-mines")

if mods.pyhightech then
    RECIPE("lead-mine"):add_ingredient_unsafe {type = "item", name = "graphene-roll", amount = 5}
end
...
ENTITY {
    ...
    circuit_connector = circuit_connector_definitions["lead-mine"],
