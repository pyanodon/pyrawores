...
ITEM {
    type = "item",
    name = "impact-crusher-mk01",
    icon = "__pyraworesgraphics__/graphics/icons/impact-crusher-mk01.png",
    icon_size = 32,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/impact-crusher-mk01/off.png",
                width = 192,
                height = 224,
                --line_length = 9,
                frame_count = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/impact-crusher-mk01/left.png",
                priority = "high",
                frame_count = 99,
                line_length = 20,
                width = 96,
        ...
        },
        {
            ...
            east_position = util.by_pixel(48, -16),
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/impact-crusher-mk01/right.png",
                priority = "high",
                frame_count = 99,
                line_length = 20,
                width = 96,
