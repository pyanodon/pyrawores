...
ITEM {
    type = "item",
    name = "flotation-cell-mk04",
    icon = "__pyraworesgraphics__/graphics/icons/flotation-cell-mk04.png",
    icon_size = 32,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/flotation-cell-mk01/off-mk04.png",
                --priority = "high",
                width = 192,
                height = 229,
                --line_length = 10,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/flotation-cell-mk01/flotation-cell-mk04.png",
                --priority = "low",
                frame_count = 100,
                line_length = 10,
                width = 192,
