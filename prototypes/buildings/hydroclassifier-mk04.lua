...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/hydroclassifier/h1-mk04.png",
                width = 96,
                height = 227,
                line_length = 21,
                frame_count = 150,
            ...
            {
                filename = "__pyraworesgraphics__/graphics/entity/hydroclassifier/h2-mk04.png",
                width = 96,
                height = 227,
                line_length = 21,
                frame_count = 150,
            ...
            {
                filename = "__pyraworesgraphics__/graphics/entity/hydroclassifier/h3-mk04.png",
                width = 32,
                height = 227,
                line_length = 21,
                frame_count = 150,
