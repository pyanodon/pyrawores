...
ITEM {
    type = "item",
    name = "smelter-mk02",
    icon = "__pyraworesgraphics__/graphics/icons/smelter-mk02.png",
    icon_size = 64,
    flags = {},
    subgroup = "py-rawores-buildings-mk02",
    order = "a",
    place_result = "smelter-mk02",
    stack_size = 10
}
...
ENTITY {
    ...
    minable = {mining_time = 0.5, result = "smelter-mk02"},
    ...
    working_sound = {
        ...
        idle_sound = {filename = "__pyraworesgraphics__/sounds/smelter.ogg", volume = 0.85},
        apparent_volume = 2.5
    }
}
