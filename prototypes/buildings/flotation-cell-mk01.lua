...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/flotation-cell/off-mk01.png",
                width = 192,
                height = 229,
                frame_count = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/flotation-cell/flotation-cell-mk01.png",
                --priority = "low",
                frame_count = 100,
                line_length = 10,
                width = 192,
