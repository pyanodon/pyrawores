...
ITEM {
    type = "item",
    name = "leaching-station-mk02",
    icon = "__pyraworesgraphics__/graphics/icons/leaching-station-mk02.png",
    icon_size = 32,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/leaching-station-mk01/off-mk02.png",
                --priority = "high",
                width = 224,
                height = 233,
                --line_length = 10,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/leaching-station-mk01/on-mk02.png",
                --priority = "extra-high",
                frame_count = 1,
                --line_length = 2,
                width = 224,
