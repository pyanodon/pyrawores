...
ITEM {
    type = "item",
    name = "bof-mk03",
    icon = "__pyraworesgraphics__/graphics/icons/bof-mk03.png",
    icon_size = 32,
    flags = {},
...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pyraworesgraphics__/graphics/entity/bof-mk01/off-mk03.png",
                --priority = "high",
                width = 256,
                height = 288,
                --line_length = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pyraworesgraphics__/graphics/entity/bof-mk01/on-mk03.png",
                priority = "high",
                frame_count = 24,
                line_length = 6,
                width = 128,
