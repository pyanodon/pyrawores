...
RECIPE("aramid"):add_ingredient {type = "item", name = "molybdenum-plate", amount = 5}:replace_category("crafting-with-fluid", "nmf")
...
RECIPE("sodium-chlorate"):remove_unlock("vanadium-processing"):add_unlock("salts"):remove_ingredient("water-saline"):add_ingredient {type = "item", name = "salt", amount = 10}:replace_category("chemistry", "electrolyzer")

RECIPE("purified-quartz"):replace_category("leaching", "pan")
RECIPE("prepared-quartz"):replace_category("leaching", "pan")
RECIPE("quartz-pulp-01"):replace_category("chemistry", "hydrocyclone")
RECIPE("al-pulp-01"):replace_category("chemistry", "mixer")
RECIPE("al-pulp-02"):replace_category("chemistry", "agitator")
RECIPE("al-pulp-04"):replace_category("chemistry", "agitator")
...
RECIPE("unslimed-iron-2"):replace_category("hydroclassifier", "hydrocyclone")

RECIPE("grade-4-chromite"):replace_category("chemistry", "hydrocyclone")

RECIPE("molybdenum-plate"):add_ingredient {type = "fluid", name = "hydrogen", amount = 100}:replace_category("chemistry", "electrolyzer")
...
RECIPE("super-alloy"):replace_ingredient("steel-plate", "nickel-plate"):add_ingredient {type = "item", name = "aramid", amount = 1}:replace_category("advanced-foundry", "py-rawores-smelter")
RECIPE("calcinate-separation"):add_result {type = "item", name = "ore-quartz", amount = 1, independent_probability = 0.6}
...
RECIPE("nbti-alloy"):replace_ingredient("steel-plate", "titanium-plate"):add_ingredient {type = "fluid", name = "nitrogen", amount = 150}:remove_unlock("nenbit-matrix"):add_unlock("alloys-mk03"):replace_category("advanced-foundry", "py-rawores-smelter")
...
RECIPE("agzn-alloy"):replace_ingredient("iron-plate", "silver-plate"):replace_ingredient("stone", "zinc-plate"):replace_category("advanced-foundry", "py-rawores-smelter")
...
RECIPE("sodium-bisulfate"):replace_category("chemistry", "mixer")
RECIPE("mibc"):replace_category("chemistry", "mixer")
...
--RECIPE("bricks-to-stone"):replace_category("crusher", "secondary-crusher")
...
RECIPE("acetylene"):replace_category("chemistry", "gasifier")
...
RECIPE("grade-2-chromite-beneficiation"):replace_category("solid-separator", "screener")
RECIPE("high-chromite"):add_ingredient {type = "fluid", name = "pressured-air", amount = 100}
RECIPE("recrush-processed-chromite"):replace_category("impact-crusher", "secondary-crusher")
...
RECIPE("crushed-coal"):replace_category("crusher", "secondary-crusher")
RECIPE("coarse-coal-to-coal"):replace_category("crusher", "secondary-crusher")
RECIPE("coarse-coal"):replace_category("solid-separator", "screener")
RECIPE("coal-pulp-02"):add_ingredient {type = "fluid", name = "pressured-air", amount = 150}
RECIPE("coal-slime-overflow"):replace_ingredient("organic-solvent", "industrial-solvent"):replace_category("chemistry", "thickener")
...
RECIPE("grade-2-copper"):replace_category("solid-separator", "screener")
RECIPE("grade-3-copper"):replace_category("solid-separator", "screener")
RECIPE("grade-4-copper"):replace_category("solid-separator", "screener")
RECIPE("high-grade-copper"):replace_category("chemistry", "agitator")
...
RECIPE("gold-precipitate"):replace_category("chemistry", "agitator")

RECIPE("grade-2-iron"):replace_category("solid-separator", "screener")
RECIPE("grade-3-iron-processing"):replace_category("solid-separator", "secondary-crusher")
RECIPE("iron-concentrate"):replace_category("chemistry", "jig")
RECIPE("iron-pulp-06-thickener"):replace_category("chemistry", "thickener")
...
RECIPE("grade-1-lead"):replace_category("solid-separator", "screener")
RECIPE("grade-2-lead"):replace_category("solid-separator", "screener")
RECIPE("grade-2-crush-lead"):replace_category("crusher", "secondary-crusher")
RECIPE("lead-refined-dust-03"):replace_category("solid-separator", "screener")
...
RECIPE("grade-3-nexelit"):replace_category("solid-separator", "screener")
RECIPE("nex-grade-2-crush"):replace_category("crusher", "secondary-crusher")
...
RECIPE("grade-3-nickel"):replace_category("solid-separator", "screener")
RECIPE("nickel-rejects-recrush"):replace_category("crusher", "secondary-crusher")
...
RECIPE("grade-1-tin"):replace_category("solid-separator", "screener")
RECIPE("grade-3-tin"):replace_category("solid-separator", "screener")
RECIPE("tin-ore-rejects"):replace_category("crusher", "secondary-crusher")
RECIPE("tin-concentrate"):replace_category("chemistry", "jig")
RECIPE("powdered-tin"):replace_category("solid-separator", "screener")
RECIPE("tin-concentrate-3"):replace_category("chemistry", "grease")
...
RECIPE("grade-1-ti"):replace_category("solid-separator", "screener")
RECIPE("grade-3-ti"):replace_category("solid-separator", "screener")
RECIPE("ti-rejects-recrush"):replace_category("crusher", "secondary-crusher")
RECIPE("powdered-ti"):replace_category("chemistry", "jig")
RECIPE("ti-enriched-dust"):replace_category("solid-separator", "screener")
...
RECIPE("grade-2-u-crush"):replace_category("crusher", "secondary-crusher")

RECIPE("powdered-zinc"):replace_category("solid-separator", "screener")
RECIPE("purified-zinc"):add_ingredient {type = "fluid", name = "grease", amount = 25}:replace_category("chemistry", "grease")
...
RECIPE("acid-solvent"):replace_category("chemistry", "mixer")
RECIPE("armac-12"):replace_category("chemistry", "mixer")
RECIPE("chromite-mix"):replace_category("chemistry", "mixer")
RECIPE("chromite-pulp-01"):replace_category("chemistry", "agitator")
RECIPE("chromite-pulp-02"):replace_category("chemistry", "pan")
...
RECIPE("chromite-pulp-07"):replace_category("chemistry", "thickener")
RECIPE("coal-fines"):replace_category("chemistry", "jig")
RECIPE("coal-pulp-01"):add_ingredient {type = "fluid", name = "pressured-air", amount = 150}
RECIPE("coal-pulp-04"):replace_category("chemistry", "jig")
RECIPE("coal-pulp-05"):add_ingredient {type = "fluid", name = "pressured-air", amount = 150}
RECIPE("conditioned-fines"):replace_category("chemistry", "pan")
RECIPE("copper-pulp-01"):add_ingredient {type = "fluid", name = "grease", amount = 10}
RECIPE("copper-solution"):replace_category("chemistry", "mixer")
RECIPE("cresylic-acid"):replace_category("chemistry", "mixer")
RECIPE("fines-pulp"):replace_category("chemistry", "jig")
RECIPE("iron-pulp-02"):replace_category("chemistry", "pan")
...
RECIPE("iron-slime"):replace_category("chemistry", "mixer")
RECIPE("nexelit-pulp-01"):add_ingredient {type = "item", name = "sodium-chlorate", amount = 2}:replace_category("chemistry", "pan")
RECIPE("nexelit-pulp-04"):add_ingredient {type = "fluid", name = "pressured-air", amount = 75}
RECIPE("nickel-overflow-2"):replace_category("chemistry", "pan")
RECIPE("nickel-pulp-01"):replace_category("chemistry", "agitator")
RECIPE("nickel-pulp-02"):add_ingredient {type = "fluid", name = "pressured-air", amount = 150}
RECIPE("outlet-gas-02"):replace_category("chemistry", "gas-separator")
RECIPE("prepared-nickel-pulp"):replace_category("chemistry", "hydrocyclone")
...
RECIPE("sl-02"):replace_category("chemistry", "hydrocyclone")
RECIPE("sl-03"):replace_category("chemistry", "thickener")
...
RECIPE("ti-pulp-02"):replace_category("chemistry", "grease")
RECIPE("ti-pulp-03"):replace_ingredient("heavy-oil", "grease"):replace_category("chemistry", "grease")
RECIPE("ti-pulp-04"):replace_category("chemistry", "thickener")
RECIPE("ti-pulp-05"):replace_category("chemistry", "hydrocyclone")
RECIPE("ti-pulp-06"):replace_category("chemistry", "pan")
RECIPE("ti-solution-02"):add_ingredient {type = "fluid", name = "pressured-air", amount = 150}
RECIPE("ti-solution"):replace_category("chemistry", "agitator")
RECIPE("tin-pulp-01"):replace_ingredient("nitrogen", "soda-ash"):replace_category("chemistry", "pan")
RECIPE("tin-pulp-02"):add_ingredient {type = "fluid", name = "pressured-air", amount = 250}
RECIPE("tin-slime-overflow"):replace_category("chemistry", "thickener")
RECIPE("tin-slime"):replace_category("chemistry", "hydrocyclone")

if not mods.pyalternativeenergy then
    RECIPE("u-15-2"):replace_category("chemistry", "thickener")
    RECIPE("u-23"):replace_category("chemistry", "thickener")
    RECIPE("u-33"):replace_category("chemistry", "thickener")
    RECIPE("u-50"):replace_category("chemistry", "hydrocyclone")
    RECIPE("u-65"):replace_category("chemistry", "hydrocyclone")
    RECIPE("u-70"):replace_category("chemistry", "thickener")
    RECIPE("u-73"):replace_category("chemistry", "mixer")
    RECIPE("u-79"):replace_ingredient("organic-solvent", "industrial-solvent")
    RECIPE("u-81"):replace_ingredient("water", "soda-ash")
    RECIPE("u-83"):replace_category("chemistry", "agitator")
...
RECIPE("u-pulp-02"):replace_category("leaching", "agitator")
RECIPE("u-rich-pulp"):replace_category("chemistry", "agitator")
RECIPE("zinc-overflow"):replace_category("chemistry", "jig")
...
RECIPE("zinc-pulp-04"):add_ingredient {type = "fluid", name = "soda-ash", amount = 300}:replace_category("chemistry", "agitator")
RECIPE("zinc-pulp-04-2"):replace_category("chemistry", "thickener")
...
if mods["pyhightech"] then
    RECIPE("aramid-2"):add_ingredient {type = "item", name = "molybdenum-plate", amount = 5}:replace_category("crafting-with-fluid", "nmf")
    RECIPE("xylenol-3"):replace_category("chemistry", "mixer")
end
