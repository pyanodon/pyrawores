...
RECIPE('electric-engine-unit'):add_ingredient({type = "item", name = "iron-stick", amount = 1}):add_ingredient({type = "item", name = "copper-cable", amount = 150}):add_ingredient({type = "item", name = "aluminium-plate", amount = 10}):add_ingredient({type = "item", name = "bolts", amount = 20}):remove_ingredient("engine-unit")
