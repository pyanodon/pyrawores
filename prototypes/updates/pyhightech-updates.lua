...
RECIPE("powdered-ralesia-seeds"):replace_category("ball-mill", "pulp")
...
RECIPE("ndfeb-alloy"):replace_ingredient("carbon-dioxide", "oxygen"):replace_category("advanced-foundry", "py-rawores-smelter")
...
RECIPE("ammonium-chloride"):replace_ingredient("water", "ammonia"):replace_category("rectisol", "fbreactor")
