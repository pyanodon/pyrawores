...
RECIPE("carbon-aerogel"):remove_ingredient("silicon"):add_ingredient({type = "item", name = "high-grade-quartz", amount = 1}):remove_ingredient("syngas"):add_ingredient({type = "fluid", name = "nitrogen", amount = 50})
