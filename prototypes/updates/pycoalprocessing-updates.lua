...
RECIPE("lens"):remove_ingredient("stone"):add_ingredient({type = "fluid", name = "molten-glass", amount = 100})
...
RECIPE("glass-core"):remove_ingredient("sand"):add_ingredient({type = "fluid", name = "molten-glass", amount = 100})
...
RECIPE("flask"):remove_ingredient("iron-plate"):add_ingredient({type = "fluid", name = "molten-glass", amount = 300})
