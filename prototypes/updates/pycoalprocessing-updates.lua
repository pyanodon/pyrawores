...
RECIPE("soil-extractor-mk02"):replace_ingredient("copper-cable", "tinned-cable")
RECIPE("soil-extractor-mk01"):replace_ingredient("copper-cable", "tinned-cable")
...
if mods.pyrawores then
    ...
    RECIPE("soil-extractor-mk02"):add_unlock("machines-mk03"):add_ingredient({ type = "item", name = "duralumin", amount = 20 }):add_ingredient({ type = "item", name = "stainless-steel", amount = 30 })
    RECIPE("soil-extractor-mk03"):add_unlock("machines-mk04"):add_ingredient({ type = "item", name = "titanium-plate", amount = 10 }):add_ingredient({ type = "item", name = "super-steel", amount = 30 })
    RECIPE("soil-extractor-mk04"):add_unlock("machines-mk05"):add_ingredient({ type = "item", name = "lead-plate", amount = 20 })
