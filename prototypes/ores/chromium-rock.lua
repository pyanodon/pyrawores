...
data:extend({
    {
        ...
        name = "py_chromium_rock_starting_area",
    ...
    {
        type = "noise-expression",
        name = "py_chromium_rock_desired_frequency",
    ...
    },
    {
        ...
        type = "noise-expression",
        name = "py_chromium_rock",
        -- Our final chance, likely a very, very small decimal
        expression = [[
            py_chromium_rock_starting_area * py_chromium_rock_desired_frequency * var("control:chromium-rock:frequency")
        ]]
    },
    {
        -- We return the richness here, which is just the quantity the resource tile yields
        type = "noise-expression",
        name = "py_chromium_rock_richness",
        expression = "2^16 * var('distance') * var('control:chromium-rock:richness')"
    }
})
...
data:extend({ {
    ...
    autoplace = {
        ...
        -- We return the chance of spawning on any given tile here
        probability_expression = "py_chromium_rock",
        -- We return the richness here, which is just the quantity the resource tile yields
        richness_expression = "py_chromium_rock_richness"
    },
    stage_counts = { 0 },
    stages = {
        sheet = {
