...
data:extend{
    {
        ...
        name = "py_uranium-rock_starting_area",
    ...
    {
        type = "noise-expression",
        name = "py_uranium-rock_desired_frequency",
    ...
    },
    {
        ...
        type = "noise-expression",
        name = "py_uranium-rock",
        -- Our final chance, likely a very, very small decimal
        expression = [[
            py_uranium-rock_starting_area * py_uranium-rock_desired_frequency * var("control-setting:uranium-rock:frequency:multiplier")
        ]]
    },
    {
        -- We return the richness here, which is just the quantity the resource tile yields
        type = "noise-expression",
        name = "py_uranium-rock_richness",
        expression = "2^16 * var('distance') * var('control-setting:uranium-rock:richness:multiplier')"
    }
}
...
data:extend{{
    ...
    autoplace = {
        ...
        -- We return the chance of spawning on any given tile here
        probability_expression = "py_uranium-rock",
        -- We return the richness here, which is just the quantity the resource tile yields
        richness_expression = "py_uranium-rock_richness"
    },
    stage_counts = {0},
    stages = {
        sheet = {
