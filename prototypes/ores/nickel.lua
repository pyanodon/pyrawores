...
ENTITY {
    ...
    minable = {
        ...
        mining_time = 2,
        results = {
			{type = "item", name = "ore-nickel-high", amount_min = 1, amount_max = 1, probability = 0.8},
...
ENTITY {
    ...
    minable = {
        ...
        mining_time = 2,
        results = {
			{type = "item", name = "ore-nickel-high", amount_min = 1, amount_max = 1, probability = 0.4},
...
ENTITY {
    ...
    minable = {
        ...
        mining_time = 2,
        results = {
			{type = "item", name = "ore-nickel-high", amount_min = 1, amount_max = 1, probability = 0.15},
...
ENTITY {
    ...
    minable = {
        ...
        mining_time = 2,
        results = {
			{type = "item", name = "ore-nickel-high", amount_min = 1, amount_max = 1, probability = 0.05},
			{type = "item", name = "ore-nickel-medium", amount_min = 1, amount_max = 1, probability = 0.2},
