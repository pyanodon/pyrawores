...
data:extend({
    ...
    },
    {
        ...
        expression = [[
            py_quartz_rock_starting_area * py_quartz_rock_desired_frequency * var("control:quartz-rock:frequency")
        ]]
    },
    {
        ...
        expression = "2^16 * var('distance') * var('control:quartz-rock:richness')"
    }
})
