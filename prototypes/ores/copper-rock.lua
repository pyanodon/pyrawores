...
data:extend({
    ...
    },
    {
        ...
        expression = [[
            py_copper_rock_starting_area * py_copper_rock_desired_frequency * var("control:copper-rock:frequency")
        ]]
    },
    {
        ...
        expression = "2^16 * var('distance') * var('control:copper-rock:richness')"
    }
})
