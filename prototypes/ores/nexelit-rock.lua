...
data:extend{{
    ...
    autoplace = {
        ...
        probability_expression = noise.define_noise_function( function(x, y, tile, map)
            ...
            local frequency_multiplier = noise.var("control-setting:nexelit-rock:frequency:multiplier")
        ...
        richness_expression = noise.define_noise_function( function(x, y, tile, map)
            ...
            local richness_multiplier = noise.var("control-setting:nexelit-rock:richness:multiplier")
