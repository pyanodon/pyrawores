...
data:extend{
    {
        ...
        name = "py_salt-rock_starting_area",
    ...
    {
        type = "noise-expression",
        name = "py_salt-rock_desired_frequency",
    ...
    },
    {
        ...
        expression = [[
            py_salt-rock_starting_area * py_salt-rock_desired_frequency * var("control-setting:salt-rock:frequency:multiplier")
        ]]
    },
    {
        -- We return the richness here, which is just the quantity the resource tile yields
        type = "noise-expression",
        name = "py_salt-rock_richness",
...
data:extend{{
    ...
    autoplace = {
        ...
        control = "salt-rock",
        -- We return the chance of spawning on any given tile here
        probability_expression = "py_salt-rock",
        -- We return the richness here, which is just the quantity the resource tile yields
        richness_expression = "py_salt-rock_richness"
    },
    stage_counts = {0},
    stages = {
        sheet = {
