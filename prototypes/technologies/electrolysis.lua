...
TECHNOLOGY {
    type = 'technology',
    name = 'electrolysis-mk03',
    icon = '__pyraworesgraphics__/graphics/technology/machines-mk03.png',
    icon_size = 128,
    order = 'c-a',
    prerequisites = {"electrolysis-mk02", "production-science-pack"},
    effects = {},
    unit = {
        count = 100,
        ingredients = {
...
TECHNOLOGY {
    type = 'technology',
    name = 'electrolysis-mk04',
    icon = '__pyraworesgraphics__/graphics/technology/machines-mk04.png',
    icon_size = 128,
    order = 'c-a',
    prerequisites = {"electrolysis-mk03", "utility-science-pack"},
    effects = {},
    unit = {
        count = 100,
        ingredients = {
